...
“[第十届全国社会媒体处理大会（The eighth China National Conference on Social Media Processing）](https://conference.cipsc.org.cn/smp2021/)”将于2021年11月12日-14日在北京召开。全国社会媒体处理大会专注于以社会媒体处理为主题的科学研究与工程开发，为传播社会媒体处理最新的学术研究与技术成果提供广泛的交流平台，旨在构建社会媒体处理领域的产学研生态圈，成为中国乃至世界社会媒体处理的风向标，会议将以社交网络的形式改变传统的学术会议交流体验。全国社会媒体处理大会每年举办一次，现已成为社会媒体处理的重要学术活动。第十届全国社会媒体处理大会（SMP 2021）由中国中文信息学会主办，中国中文信息学会社会媒体处理专委会、北京邮电大学、北京大学承办。

在本届SMP 2021会议上，我们将举办第二届中文隐式情感分析评测（SMP-ECISA 2021）。该任务是SMP-ECISA 2019的进一步延续。近年来，显式情感分析已经取得了良好的进展与丰硕的成果，但隐式情感分析仍属于一个较为新颖的研究问题。对隐式情感展开深入的研究成果将有助于更全面、更精确地提升文本情感分析的效果，可为文本表示学习、自然语言理解、用户建模、知识嵌入等方面研究起到积极的推动作用，进一步促进基于文本情感分析相关领域的应用和产业的快速发展。

本届中文隐式情感分析评测由中国中文信息学会社会媒体处理专委会主办，山西大学计算机与信息技术学院承办并提供标注数据集，微热点大数据研究院提供测试的原始数据，旨在促进中文隐式情感分析相关研究的发展，为本领域的学术研究人员和产业界从业人员提供一个良好的沟通平台。本次评测总奖金20000元。热烈欢迎对中文隐式情感分析感兴趣的个人和团队积极报名参赛！
...
**请注意本评测报名与发布训练集在线评测平台是独立的，所有参赛队伍需填写下方的报名表进行报名参赛。**
...
本次中文隐式情感分析评测使用的数据集由山西大学标注，微热点大数据研究院提供测试集的原始数据。数据来源主要来自微博，主要领域/主题包括但不限于：春晚、雾霾、乐视、国考、旅游、端午节、开学延期、英国脱欧、美国大选、肖战227事件、黑人遭暴力执法等。
...
数据集已通过评测官方邮箱sxu_nlp@163.com发至各参赛队队长邮箱，若未收到邮件，请及时与我们联系。**请注意本评测报名与发布训练集在线评测平台是独立的，所有参赛队伍需填写本页面上方的报名表进行报名参赛。**
...
组织方会根据参赛队伍在测试集上的得分进行排名，并在8月8日、15日、22日在GitHub[排行榜](https://github.com/sxu-nlp/ECISA2021/blob/main/%E6%8E%92%E8%A1%8C%E6%A6%9C.md)上公布该周各个队伍的排名及分数信息。以8月22日的排名结果作为本次评测的最终结果，并将会在SMP2021官方网站公布。
...
评测指导：秦兵（哈尔滨工业大学）、林鸿飞（大连理工大学）、徐睿峰（哈尔滨工业大学(深圳)）、赵妍妍（哈尔滨工业大学）

评测主席：廖健（山西大学）、王素格（山西大学）
...
- 数据集的具体内容、范围、规模及格式以最终发布的真实数据集为准。最终解释权归于SMP2021与山西大学计算机与信息技术学院。
