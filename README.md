...
- 2021-04-10 🚩 排行榜发布： Leaderboard
- 2021-04-05 基线系统发布： SpaCE2021-Baseline
- 2021-04-05 开放数据提交： 提交结果
- 2021-04-01 开放报名： 我要报名
- 2021-04-01 数据集 pack1 发布，使用前请阅读 数据集使用许可
- 2021-04-01 供参考的评分脚本： evaluate.py
