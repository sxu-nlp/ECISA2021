...
组织方会根据参赛队伍在测试集上的得分进行排名，并在8月8日、15日、22日在GitHub[排行榜](https://github.com/sxu-nlp/ECISA2021/edit/main/README.md)上公布该周各个队伍的排名及分数信息。以8月22日的排名结果作为本次评测的最终结果，并将会在SMP2021官方网站公布。
