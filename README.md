...
本届中文隐式情感分析评测由中国中文信息学会社会媒体处理专委会主办，山西大学计算机与信息技术学院承办并提供数据集，总奖金20000元。本次评测旨在促进中文隐式情感分析相关研究的发展，为本领域的学术研究人员和产业界从业人员提供一个良好的沟通平台。热烈欢迎对中文隐式情感分析感兴趣的个人和团队积极报名参赛！
...
本次中文隐式情感分析评测使用的数据集由山西大学标注，数据来源主要来自微博，主要领域/主题包括但不限于：春晚、雾霾、乐视、国考、旅游、端午节、开学延期、英国脱欧、美国大选、肖战227事件、黑人遭暴力执法等。
